...
$_['text_email']      = 'З усіх питань пишіть:';

// Entry
$_['entry_name'] = 'Ім&#39;я';
$_['entry_email'] = 'E-Mail';
$_['entry_enquiry'] = 'Ваш питання або повідомлення';
$_['entry_spam']  = 'Ми не розсилаємо спам і не передаємо інформацію про вас третім особам.';
$_['entry_confidential']  = 'Детальніше про політику конфіденційності';
