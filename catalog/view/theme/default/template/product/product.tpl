                            ...
                            <div class="item-description">
                                ...
                                <ul class="properties">
                                    <li>
                                        ...
                                        <p>Категория товара: <span><?php echo $cat_name['name']; ?></span></p>
                                        <?php } ?>
                                        <?php } ?>
                                    </li>
                                    <?php if ($upc) { ?>
                                    <li>
                                        <p>
											...
											<span class="info-wrapper">
												...
												<span class="info-title">Тип цоколя</span>
                                    ...
                                    <?php if ($jan) { ?>
                                    <li>
                                        <p><?php echo $entry_jan; ?> <span><?php echo $jan; ?></span></p>
                                    </li>
                                    <?php } else { ?>
                                    <li></li>
                                    <?php } ?>
                                ...
                                <div class="item-price">
                                    <h4 class="in-stock">В наличии на складе: <?php echo $stock; ?> шт.</h4>
                                    <?php if ($price) { ?>
                                ...
                                <div class="add-to-cart" id="product">
                                    <ul class="buttons clearfix">
                                        ...
                                        <li>
                                            <button type="button" id="button-cart" data-loading-text="<?php echo $text_loading; ?>" class="button colored">
                                    ...
                                    <ul class="buttons clearfix">
                                        <li class="oneclick">
                                            <a href="#" class="button bordered">
                                                <img src="/image/unilight//product-card/oneclick.png" alt="">
                                                Купить в 1 клик
                                            </a>
                                        </li>
                                        <li class="icon">
                ...
                $.ajax({
                    ...
                    success: function(json) {
                        ...
                        if (json['success']) {
                            ...
                            $('#cart > button').html('<img src="/image/unilight/icons/cart.svg" alt=""><span class="caption">Корзина' + '<span class="item-count">' + json['total'] + '</span>' + '<span class="item-price">' + json['text_currency'] + '</span>');
