...
<div class="container">
    ...
    <div class="row"><?php echo $column_left; ?>
        ...
        <section class="s-ordering">
            <div class="container">
<style>
    .simplecheckout-table-form-left {width: 20%;}
    .simplecheckout-button-block  {border: none;!important}
    .simplecheckout-button-block > .simplecheckout-button-right > input {color:black;
    background-color: #F5C646;
    }
    .simplecheckout-block-content {border: none;}
        ...
        <div class="simplecheckout">
            <?php if (!$cart_empty) { ?>
                ...
                <?php
                    $replace = array(
                        ...
                        '{/three_column}'    => '</div>',
                        '{left_column}'      => '<div class="col-md-5 col-sm-7"><div class="ordering">
                    <div class="tabs"><div class="tabs-content is-open"><div class="ordering-form">',
                        '{/left_column}'     => '</div></div></div></div></div>',
                        '{right_column}'     => '<div class="col-md-7 col-sm-12 sticky">',
                        '{/right_column}'    => '</div>',
                ...
                <?php if (!$block_order) { ?>
                    <div class="simplecheckout-button-block buttons" id="buttons">
                        <div class="simplecheckout-button-right">
                            ...
                            <?php if ($steps_count > 1) { ?>
                            <a style="cursor: pointer" class="button colored" data-onclick="nextStep" id="simplecheckout_button_next"><span><?php echo $button_next; ?></span></a>
                            <?php } ?>
                            <a style="cursor: pointer" class="button colored" data-onclick="createOrder" id="simplecheckout_button_confirm"><span><?php echo $button_order; ?></span></a>
                        </div>
            ...
            <?php } else { ?>
                ...
                <div class="simplecheckout-button-block buttons">
                    <div class="simplecheckout-button-right"><a style="cursor: pointer" class="button colored" href="<?php echo $continue; ?>" ><span><?php echo $button_continue; ?></span></a></div>
                </div>
            <?php } ?>
        </div>
    </div>
