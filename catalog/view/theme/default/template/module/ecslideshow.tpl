<div class="ecslideshow <?php echo (isset($support_rtl) && $support_rtl)?'rtl':'';?>" style="max-width:<?php echo $module_width;?>;">
...
<style type="text/css">
	...
	<?php } ?>
	<?php if($addtocart_bg_color){ ?>
		.camera_caption button{
		    background-color:#<?php echo $addtocart_bg_color;?>;
		}
	<?php } ?>
	<?php if($addtocart_color){ ?>
		.camera_caption button{
		    color:#<?php echo $addtocart_color;?>;
		}
	<?php } ?>
	<?php if($price_color){ ?>
		.camera_caption .price, .camera_caption .price .price-old{
		    color:#<?php echo $price_color;?>;
		}
	<?php } ?>
	<?php if($special_price_color){ ?>
		.camera_caption .price, .camera_caption .price .price-new{
		    color:#<?php echo $special_price_color;?>;
		}
	<?php } ?>
