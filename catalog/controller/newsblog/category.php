...
class ControllerNewsBlogCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			if ($settings && isset($settings['show_comments_vk_id']) && isset($settings['show_comments_vk_category'])) {
            ...
            if ($settings && isset($settings['show_comments_fb_category']))
            $data['comments_fb'] = true;
            else
            $data['comments_fb'] = false;

            if ($settings && isset($settings['show_comments_dq_id']) && isset($settings['show_comments_dq_category']))
