...
class ControllerCommonCart extends Controller {
	public function index() {
        ...
        $data['text_currency'] = sprintf($this->language->get('text_currency'), $this->currency->format($total));
		$data['text_loading'] = $this->language->get('text_loading');
        $data['text_shopping_cart'] = $this->language->get('text_shopping_cart');
        $data['text_text_inner'] = $this->language->get('text_text_inner');
        $data['text_inner'] = $this->language->get('text_inner');
        $data['text_items_text'] = $this->language->get('text_items_text');
