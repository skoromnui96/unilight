...
<div id="content">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tr>
              ...
              <td class="text-left"><?php echo "Описание" ?></td>
              <td class="text-left"><?php echo $entry_image; ?></td>
              <td class="text-left"><?php echo 'Ид видео с Youtube'; ?></td>
            ...
            <tr id="image-row<?php echo $image_row; ?>">
              ...
              <td class="text-left"><textarea name="banner_image[<?php echo $image_row; ?>][description]" cols="100" rows="10" placeholder="Описание" class="form-control"><?php echo $banner_image['description']; ?></textarea></td>
              ...
              <td class="text-left" style="width: 10%;"><input type="text" name="banner_image[<?php echo $image_row; ?>][video]" value="<?=$banner_image['video']?>"></td>
  ...
  <script type="text/javascript"><!--
      ...
      <?php foreach ($languages as $language) { ?>
          ...
          html += '  <td class="text-left"><textarea name="banner_image[' + image_row + '][description]" cols="100" rows="10" class="form-control" /></td>';
          ...
          html += '  <td class="text-left" style="width: 10%;"><input type="text" name="banner_image[' + image_row + '][video]"></td>';
