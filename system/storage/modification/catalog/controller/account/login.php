	...
	public function index() {
		...
		if (!empty($this->request->get['token'])) {
			...
			if ($customer_info && $this->customer->login($customer_info['email'], '', true)) {
				...
				$this->response->redirect($this->url->link('account/simpleedit', '', 'SSL'));
			}
		}
		...
		$data['text_confidential'] = $this->language->get('text_confidential');
		$data['text_has_account'] = $this->language->get('text_has_account');
