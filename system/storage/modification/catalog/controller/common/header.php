...
class ControllerCommonHeader extends Controller {
	public function index() {
        ...
        $data['partner'] = $this->language->get('partner');
        $data['contacts'] = $this->language->get('contacts');
        $data['comparison'] = $this->language->get('comparison');
        $data['my_favorites'] = $this->language->get('my_favorites');
        $data['chandeliers'] = $this->language->get('chandeliers');
        $data['fixtures'] = $this->language->get('fixtures');
        $data['sconce'] = $this->language->get('sconce');
        $data['spots'] = $this->language->get('spots');
        $data['floor_lamps'] = $this->language->get('floor_lamps');
        $data['table_lamps'] = $this->language->get('table_lamps');
        $data['street_lights'] = $this->language->get('street_lights');
        $data['backlight'] = $this->language->get('backlight');
        $data['bulbs'] = $this->language->get('bulbs');
        $data['accessories'] = $this->language->get('accessories');
        $data['off'] = $this->language->get('off');
        $data['dimmers'] = $this->language->get('dimmers');
        $data['sockets'] = $this->language->get('sockets');
        $data['extension_pieces'] = $this->language->get('extension_pieces');
        $data['plafonds'] = $this->language->get('plafonds');
			...
			if ($category['top']) {
				...
				foreach ($children as $child) {
					...
					$children_data[] = array(
                        ...
                        'thumb' =>$this->model_tool_image->resize($child['image'], 19, 19),
					);
				}
				...
				$data['categories'][] = array(
                    ...
                    'thumb'    => $this->model_tool_image->resize($category['image'], 72, 70),
				);
			}
		}
