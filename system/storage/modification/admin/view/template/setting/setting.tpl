        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-telephone"><?php echo $entry_telephone3; ?></label>
                  <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-video-view-type"><?php echo $entry_video_view_type; ?></label>
                  <div class="col-sm-10">
                    <select name="config_video_view_type" id="input-video-view-type" class="form-control">
		      <option value="0"><?php echo $text_none; ?></option>
                      <?php foreach ($video_view_types as $type_id => $name) { ?>
                      <?php if ($type_id == $config_video_view_type) { ?>
