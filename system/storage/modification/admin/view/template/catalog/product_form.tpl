          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group<?php echo ($hide_upc == true)? ' hide':''; ?>">
                <label class="col-sm-2 control-labelone" for="input-upc"><span data-toggle="tooltip"><?php echo $entry_upc; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group<?php echo ($hide_ean == true)? ' hide':''; ?>">
                <label class="col-sm-2 control-labelone" for="input-ean"><span data-toggle="tooltip" title="<?php echo $help_ean; ?>"><?php echo $entry_ean; ?></span></label>
                <div class="col-sm-10">
              ...
              <!-- <div class="form-group<?php echo ($hide_jan == true)? ' hide':''; ?>">
                <label class="col-sm-2 control-labelone" for="input-jan"><span data-toggle="tooltip" title="<?php echo $help_jan; ?>"><?php echo $entry_jan; ?></span></label>
                <div class="col-sm-10">
            ...
            <div class="tab-pane" id="tab-video">
              <div class="table-responsive">
                <table class="table table-striped table-bordered table-hover">
                    <tr>
                      <td class="v-preview" class="text-left"><img id="thumb_v" class="img-thumbnail" src="<?php echo $thumb_video; ?>" alt="" title="" data-placeholder="<?php echo $no_video; ?>" /></td>
                      <td class="text-left"><input type="text" id="video" name="video" value="<?php echo $video; ?>" onchange="video_preview()" placeholder="<?php echo $entry_video_link; ?>" class="form-control" /></td>

                      <td class="text-right"><input type="text" name="video_title" value="<?php echo $video_title; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" /></td>

                      <td class="clear-button text-center"><?php if ($video) { ?><button type="button" id="clear_video" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button><?php } ?></td>
                  </tr>
                </table>
              </div>

	      <legend><?php echo $entry_add_video; ?></legend>	      
              <div class="table-responsive">
                <table id="videos" class="table table-striped table-bordered table-hover">
                  <thead>
                    <tr>
                      <td class="text-left"><?php echo $entry_video_link; ?></td>
		      <td class="text-left"><?php echo $entry_title; ?></td>
                      <td class="text-left"><?php echo $entry_sorting; ?></td>
                      <td></td>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr id="video-row<?php echo $video_row; ?>">
                      <td class="text-left"><input type="text" name="product_video[<?php echo $video_row; ?>][video]" id="product_video<?php echo $video_row; ?>" value="<?php echo $product_video['video']; ?>" placeholder="<?php echo $entry_video_link; ?>" class="video_item form-control" /></td>
                      <td class="text-right"><input type="text" name="product_video[<?php echo $video_row; ?>][title]" value="<?php echo $product_video['title']; ?>" placeholder="<?php echo $entry_title; ?>" class="form-control" /></td>
                      <td class="text-right"><input type="text" name="product_video[<?php echo $video_row; ?>][sort_order]" value="<?php echo $product_video['sort_order']; ?>" placeholder="<?php echo $entry_sorting; ?>" class="form-control" /></td>
                      <td class="text-center"><button type="button" onclick="$('#video-row<?php echo $video_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                    </tr>
                    <?php $video_row++; ?>
                    <?php } ?>
                  </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="3"></td>
                      <td class="text-center"><button type="button" onclick="addVideo();" data-toggle="tooltip" title="<?php echo $button_video_add; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
                    </tr>
                  </tfoot>
                </table>
              </div>
...
<script type="text/javascript"><!--
		function video_preview() {
		   var video_value = $('#video').val(); 
		   	if (video_value) {
			var patt = /\b(http|https)/;
				if (patt.test(video_value)) {
					var re = /(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/;
					video_id = video_value.match(re)[2];
				}else{
					video_id = video_value;
				}
			$('#video').val(video_id);
		   	$('#thumb_v').attr('src','http://img.youtube.com/vi/' + video_id + '/mqdefault.jpg');
			$('.clear-button').html('<button type="button" id="clear_video" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button>');
		   	}else{
			$('#thumb_v').attr('src','<?php echo $no_video; ?>');
		...
		$('body').on('change', '.video_item', function() {
		   var item_id = this.id; 
...
function addVideo() {
	...
	html += '  <td class="text-left"><input type="text" name="product_video[' + video_row + '][video]" id="product_video' + video_row + '" value="" placeholder="<?php echo $entry_video_link; ?>" class="video_item form-control" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_video[' + video_row + '][title]" value="" placeholder="<?php echo $entry_title; ?>" class="form-control" /></td>';
	html += '  <td class="text-right"><input type="text" name="product_video[' + video_row + '][sort_order]" value="" placeholder="<?php echo $entry_sorting; ?>" class="form-control" /></td>';
	html += '  <td class="text-center"><button type="button" onclick="$(\'#video-row' + video_row  + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
	html += '</tr>';
