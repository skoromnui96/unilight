...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
      ...
      $this->request->post['config_address'] = $this->request->post['config_langdata'][$front_language_id]['comment'];
	    ...
	    $data['entry_video_view_type'] = $this->language->get('entry_video_view_type');
		...
		$data['video_view_types'] = array(
			"1" => $this->language->get('text_video_type_1'), 
			"2" => $this->language->get('text_video_type_2'), 
			"3" => $this->language->get('text_video_type_3')
		);

		if (isset($this->request->post['config_video_view_type'])) {
			$data['config_video_view_type'] = $this->request->post['config_video_view_type'];
		} else {
			$data['config_video_view_type'] = $this->config->get('config_video_view_type');		
		}
