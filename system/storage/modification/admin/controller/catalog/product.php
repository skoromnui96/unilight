...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getForm() {
        ...
        $data['entry_add_video'] = $this->language->get('entry_add_video');
        ...
        $this->document->addStyle('view/stylesheet/tabvideo.css');
        ...
        if (isset($this->request->post['video'])) {
            ...
            if ($product_info['video']) {
                ...
                if (!$video_id) {
                    $data['thumb_video'] = $this->model_tool_image->resize('no_image.png', 320, 180);
                }
            } else {
                $data['thumb_video'] = $this->model_tool_image->resize('no_image.png', 320, 180);
            }
            ...
            if ($video_id) {
                ...
                $data['thumb_video'] = $this->model_tool_image->resize('catalog/video/' .$video_id. '.jpg', 320, 180);
            }
            $data['no_video'] = $this->model_tool_image->resize('no_image.png', 320, 180);
        } else {
            $data['video'] = '';
            $data['video_title'] = '';
            $data['thumb_video'] = $this->model_tool_image->resize('no_image.png', 320, 180);
